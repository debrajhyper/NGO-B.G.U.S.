...
<body>
    ...
    <main id="payment" class="page payment-page">
        <section class="clean-block payment-form dark">
            ...
            <div class="container">
                <div id="fail" class="beautiful bs-callout bs-callout-success">
                    <?php
                    $status = $_POST["status"];
                    ...
                    if ($hash != $posted_hash) {
                        ...
                        echo "<h4>Your donation status is " . $status . ".</h4>";
                        echo "<p>Your transaction id for this transaction is " . $txnid . ". You may try making the payment by clicking the link below.</p>";
                    }
                    ?>
                </div>
            </div>
            <div class="container" style="margin-top: 60px;"><a class="btn btn-lg d-xl-flex justify-content-xl-center align-items-xl-center hero-button2" role="button" data-aos="fade-up" data-aos-delay="150" href="payment.php" style="background-color: #e98f8f;margin-right: 3rem;margin-left: 3rem;color: rgb(255,255,255);margin-bottom: 8px;">Donate Again</a></div>
        </section>
    </main>
